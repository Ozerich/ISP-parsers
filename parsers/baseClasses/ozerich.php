...
{ 
    ...
    private $prefixs = array("ТРК","ТД","магазин","ТРЦ","ЦММ","ТК","ТЦ", "Салон", "СТЦ","Молл","МТДЦ", "ТОЦ","CТЦ", "МЦ", "Студия", "Торговый центр", "РТЦ","РК","ТМ", "Большой ТЦ", "Малый ТЦ","Гипермаркет","Pepe Jeans", "Бутик", "Эксклюзивный отдел", "АТК", "БЦ", "Галерея моды", "СК", "ЦТиР", "Универмаг","Молл", "Мегацентр","сеть магазинов", "Центр","Салон-магазин","ЦУМ","магазины");
